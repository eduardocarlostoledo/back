            ...
            <html>            
              ...
              <body style="background-color: #232326; display: flex; margin-top: 80px; flex-direction: column; align-items: center;">
                <div style="display: flex; flex-direction: column; align-items: center; text-align: center; border: 1px solid black; border-radius: 20px; background-color: #ffffff; padding: 20px;"">
                  <a style="margin-bottom: 10px;" href="https://storecomputer.netlify.app"><svg className='succes_svg' width="50px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"><path style="fill:#232326" d="M24 12.001H2.914l5.294-5.295-.707-.707L1 12.501l6.5 6.5.707-.707-5.293-5.293H24v-1z" data-name="Left"/></svg></a>
                    ...
                    <a style="margin-bottom: 10px;" href="https://storecomputer.netlify.app/Products" className="succes_a">Keep Buying</a>
...
payRouter.get("/feedback/pending", async function (req, res) {
  try {
    ...
    <html>
      ...
      <body style="background-color: #232326; display: flex; margin-top: 80px; flex-direction: column; align-items: center;">
        <div style="display: flex; flex-direction: column; align-items: center; text-align: center; border: 1px solid black; border-radius: 20px; background-color: #ffffff; padding: 20px;"">
          <a style="margin-bottom: 10px;" href="https://storecomputer.netlify.app/"><svg className='pending_svg' width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"><path style="fill:#232326" d="M24 12.001H2.914l5.294-5.295-.707-.707L1 12.501l6.5 6.5.707-.707-5.293-5.293H24v-1z" data-name="Left"/></svg></a>
          ...
          <a style="margin-bottom: 10px;" className="pending_a" href="https://storecomputer.netlify.app/Products">Keep Buying</a>
...
payRouter.get("/feedback/failure", async function (req, res) {
  try {
    ...
    <html>
      ...
      <body style="background-color: #232326; display: flex; margin-top: 80px; flex-direction: column; align-items: center;">
        <div style="display: flex; flex-direction: column; align-items: center; text-align: center; border: 1px solid black; border-radius: 20px; background-color: #ffffff; padding: 20px;"">
        <a style="margin-bottom: 10px;" href="https://storecomputer.netlify.app"><svg className='failure_svg' width="30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"><path style="fill:#232326" d="M24 12.001H2.914l5.294-5.295-.707-.707L1 12.501l6.5 6.5.707-.707-5.293-5.293H24v-1z" data-name="Left"/></svg></a>
        ...
        <a style="margin-bottom: 10px;" href="https://storecomputer.netlify.app/Products" className="failure_a">Keep Buying</a>
